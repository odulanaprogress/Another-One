import { expectError, expectType } from 'npm:tsd@^0.33.0'
import { PostgrestSingleResponse, SupabaseClient, createClient } from '../../src/index.ts'
import { Database, Json } from '../types.ts'
